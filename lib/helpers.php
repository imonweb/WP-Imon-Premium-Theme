...
function _themename_post_meta(){
  ...
  echo '<time datetime="' . esc_url(get_the_date('c')) . '">' . esc_html(get_the_date('l, F j, Y')) . '</time>';
  echo '</a>';
  echo ' By <a href="' . esc_url(get_author_posts_url( get_the_author_meta('ID'))) . '">' . esc_url(get_the_author()) . '</a>';
}
